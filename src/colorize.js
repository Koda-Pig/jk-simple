export function w3CodeColorize(x, lang) {
  var tagcolor = "#999";
  var tagnamecolor = "#00b9ff";
  var attributecolor = "red";
  var attributevaluecolor = "#999";
  var commentcolor = "green";
  var cssselectorcolor = "#00b9ff";
  var csspropertycolor = "red";
  var csspropertyvaluecolor = "#999";
  var cssdelimitercolor = "yellow";
  var cssimportantcolor = "red";
  var jscolor = "yellow";
  var jskeywordcolor = "#999";
  var jsstringcolor = "#00b9ff";
  var jsnumbercolor = "red";
  var jspropertycolor = "yellow";
  ...
  function extract(str, start, end, func, repl) {
    ...
    // Convert regex to string for indexOf if needed
    var startPattern = start;
    if (start instanceof RegExp) {
      startPattern = start.source;
    }
  ...
  function getPos(txt, start, end, func) {
    var s, e;
    s = txt.search(start);
    e = txt.indexOf(end, s + (typeof end === "string" ? end.length : 1));
    if (e == -1) {
      e = txt.length;
    }
    return [s, e + (typeof end === "string" ? end.length : 1), func];
  }
